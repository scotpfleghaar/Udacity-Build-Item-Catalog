# All imports required for project
import random  # used to create random token
import string
import httplib2
import json
import requests
...
def editRestaurant(restaurant_id):
    ...
    if editedRestaurant.user_id != login_session['user_id']:
        ...
        are not authorized to edit this restaurant. Please create
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return ''' "<script>function myFunction() {alert('You
        are not authorized to edit menu items to this restaurant.
...
def deleteMenuItem(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        ...
        not authorized to delete menu items to this restaurant.
